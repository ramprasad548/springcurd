...
public class ContactHistoryVendorException extends Exception {
	...
	public ContactHistoryVendorException(VENDOR_ERROR_CODE_ENUM errorCode,List<String> errors){
		this.vendorErrorCode = errorCode;
		this.errors = errors;
	}
	
	public ContactHistoryVendorException(ERROR_CODE_ENUM errorCode,List<String> errors){
		this.errorCode = errorCode;
		this.errors = errors;
	}
	public ContactHistoryVendorException(ERROR_CODE_ENUM errorCode,String message, Throwable cause){
		super(message, cause);
		this.errorCode = errorCode;
	}
	
	public ContactHistoryVendorException(VENDOR_ERROR_CODE_ENUM errorCode, String message, Throwable cause){
		super(message, cause);
		this.vendorErrorCode = errorCode;
	}
	
	public ContactHistoryVendorException(Exception ex){
		super(ex);
	}
